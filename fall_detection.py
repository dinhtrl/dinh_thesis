...
def yolo_detection():
    ...
    #video_path = 'rtsp://admin:Minh291202%40@192.168.137.51:554/cam/realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif'
    ...
    while True:
        ...
        if not success:
            print("Không thể đọc video. Kiểm tra nguồn video hoặc kết nối mạng.")
            break
                ...
                if currentClass in classNames and conf > 0.50:
                    ...
                    if currentClass == "fall":
                        ...
                        if time.time() - start_time >= 10:
                            ...
                            # Lưu video trong 10 giây
                            for _ in range(int(10 * 20)):
                                success, frame = cap.read()
                                if not success:
                                    print("Không thể đọc khung hình cho video. Dừng lại.")
                                    break
